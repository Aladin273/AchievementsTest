 ...
 */
UCLASS()
class ACHIEVEMENTSTEST_API UATGameUserSettings : public UGameUserSettings
{
	GENERATED_BODY()
	
public:
	UFUNCTION(BlueprintCallable)
	static UATGameUserSettings* GetATGameUserSettings()
	{
		return Cast<UATGameUserSettings>(UGameUserSettings::GetGameUserSettings());
	}
